    ...
    return (
      <div>
        ...
        <h1 className="display-5 fw-bold">Order for Pickup/Delivery</h1>
            ...
            <Link className="nav-link bg-dark mb-5" to="/menu" style={{padding: 0, width: 'max-content', height: '3rem'}} >
            <button className="btn btn-warning btn-lg mb-5" type="button">
              Menu
            </button>
            </Link>
        ...
        <div className="row">
          ...
          <div className="col-lg-4">
            <div className="box text-center">
              ...
              <img
                    ...
                    />
                     <Link to={{ pathname: "https://www.grubhub.com/restaurant/best-panda-chinese-restaurant-4949-grand-ave-ste-4a-gurnee/1044083" }} target="GrubHub">
                    <button
                      type="button"
          ...
          <div className="box text-center">
              ...
              <img
                      ...
                      className="d-inline-block align-text-top"
                    />
                    <Link to={{ pathname: "https://www.doordash.com/store/best-panda-chinese-restaurant-gurnee-757771/" }} target="DoorDash">
                    <button
                      type="button"
                      className="w-100 btn btn-lg btn-dark mt-3"
                      style={{fontSize: '1.2rem'}}
